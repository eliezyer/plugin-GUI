...
static const char* plugin_in_the_editor	= "Detector"; // Tells the JUCE application the name of this shared library.
...
static GenericProcessor* pluginMainClass(){ return new Detector(); };	// Tells the JUCE the class that contains the implemented processor, plugin, interface.
